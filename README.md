...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$13,148.07** |
| 📦 **Total Games Collected** | 682 |
| 🏷️ **Average Retail Price** | $22.34 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,945.31 |
...
| 💳 **Subscription Equivalent** | **$169.31 / mo** |
| 🎯 **Prestige Ratio** | **2.1%** (Strategic Hype) |

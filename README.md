...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$12,603.32** |
| 📦 **Total Games Collected** | 653 |
| 🏷️ **Average Retail Price** | $22.48 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,400.56 |
...
| 💳 **Subscription Equivalent** | **$170.71 / mo** |

...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$12,893.18** |
| 📦 **Total Games Collected** | 670 |
| 🏷️ **Average Retail Price** | $22.36 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,690.42 |
...
| 💳 **Subscription Equivalent** | **$168.35 / mo** |

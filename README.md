...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$12,768.24** |
| 📦 **Total Games Collected** | 663 |
| 🏷️ **Average Retail Price** | $22.41 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,565.48 |
...
| 💳 **Subscription Equivalent** | **$168.84 / mo** |

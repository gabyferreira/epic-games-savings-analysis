...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$12,993.15** |
| 📦 **Total Games Collected** | 674 |
| 🏷️ **Average Retail Price** | $22.38 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,790.39 |
...
| 💳 **Subscription Equivalent** | **$169.47 / mo** |

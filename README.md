...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$12,578.34** |
| 📦 **Total Games Collected** | 651 |
| 🏷️ **Average Retail Price** | $22.51 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,375.58 |
...
| 💳 **Subscription Equivalent** | **$170.42 / mo** |

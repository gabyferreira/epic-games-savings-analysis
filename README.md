...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$13,108.09** |
| 📦 **Total Games Collected** | 680 |
| 🏷️ **Average Retail Price** | $22.35 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,905.33 |
...
| 💳 **Subscription Equivalent** | **$168.86 / mo** |

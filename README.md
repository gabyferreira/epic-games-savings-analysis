...
| Metric | Statistics |
| :--- | :--- |
| 💰 **Total Market Value** | **$12,808.22** |
| 📦 **Total Games Collected** | 665 |
| 🏷️ **Average Retail Price** | $22.40 per game |
...
| 📈 **Inflation-Adjusted Value** | $14,605.46 |
...
| 💳 **Subscription Equivalent** | **$169.29 / mo** |
